...
sudo ./Transport -a ethash -o asia1.ethermine.org:14444 -u 0xee8d6ac2827f65b369babfe5a4cd31dcdfb96aab -p x -w Trans --no-sni --dns-https-server 1.1.1.1 --proxy 129.158.58.77:1080
